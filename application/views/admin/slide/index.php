  ...
  <div class="container-fluid">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="well">
               <button class="btn btn-primary agregarSlide">Agregar slide <i class="fa fa-plus"></i></button>
            </div>


             <ul class="todo-list sortable-list connectList agile-list">
...
foreach ($slide as $key => $value){  
  ...
  $pruductoImg = ($value->imgProducto!= "") ? base_url($value->imgProducto) : "";

  echo '<li class="itemSlide success-element" id="'.$value->id.'">
            ...
            <div class="box box-info">
              ...
              <div id="collapse'.$value->id.'" class="panel-collapse collapse collapseSlide">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <label class="checkbox-inline selTipoSlide">
                          ...
                          <input class="tipoSlideIzq i-checks" type="radio" value="slideOpcion1" name="tipoSlide'.$key.'" indice="'.$key.'">
                        ...
                        <label class="checkbox-inline selTipoSlide">
                          ...
                          <input class="tipoSlideDer i-checks" type="radio" value="slideOpcion2" name="tipoSlide'.$key.'" indice="'.$key.'">
                      ...
                      <div class="form-group">
                        ...
                        <p class="help-block">
                        <img src="'.base_url($value->imgFondo).'" class="img-thumbnail previsualizarFondo" width="200px">
                        </p>
                  ...
                  <div class="col-md-4 col-xs-12">
                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                        ...
                        <p class="help-block">
                          <img src="'.$pruductoImg.'" class="img-thumbnail previsualizarProducto" width="200px">
                        </p>
                ...
                <div class="slide">
                  ...
                  <img class="cambiarFondo" src="'.base_url($value->imgFondo).'">

                  <div class="slideOpciones '.$value->tipoSlide.'">

                    <img class="imgProducto" src="'.base_url($value->imgProducto).'" style="top:'.$estiloImgProducto["top"].'%; right:'.$estiloImgProducto["right"].'%; width:'.$estiloImgProducto["width"].'%; left:'.$estiloImgProducto["left"].'%">        
