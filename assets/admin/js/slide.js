...
$(".agregarSlide").click(function(){
	...
	var imgFondo = "assets/portal/img/slide/default/fondo.jpg";
	...
	$.ajax({
		...
		url: base_url("slide/ajaxCrearSlide"),
		method: "POST",
		data: datos,
		cache: false,
		contentType: false,
    ...
    stop: function(event){
    	...
    	for(var i = 0; i < itemSlide.length; i++){
			...
			$.ajax({
				...
				url:base_url("slide/ajaxOrdenSlide"),
				method: "POST",
				data: datos,
				cache: false,
				contentType: false,
...
$(".guardarSlide").click(function(){
   ...
   // CAPTURAMOS EL TÍTULO 2
	...
	$.ajax({
		...
		url: base_url("slide/ctrActualizarSlide"),
		method: "POST",
		data: datos,
		cache: false,
		contentType: false,
...
$(".eliminarSlide").click(function(){
	...
	swal({
        ...
        $.ajax({
			url: base_url("slide/ctrEliminarSlide"),
			method: "POST",
			data: datos,
			cache: false,
			contentType: false,
